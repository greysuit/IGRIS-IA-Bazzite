...
def openrouter_agent(query: str, model: str = "google/gemini-2.5-flash") -> str:
    ...
    if provider == "ollama":
        ...
        payload = {
            "model": ollama_model,
            "messages": [
                {"role": "system", "content": "Eres JARVIS, un asistente inteligente local. Responde de forma clara, directa, muy concisa y al grano en español. Evita preámbulos y respuestas innecesariamente largas para responder a máxima velocidad."},
    ...
    # 2. CLOUD OPENROUTER ROUTING (Default)
        ...
        payload = {
            ...
            "max_tokens": 1500,
            "messages": [
                {"role": "system", "content": "Eres un Agente Especialista de JARVIS. Responde de forma clara, directa y muy concisa en español. Evita rodeos, preámbulos o introducciones innecesarias para optimizar el tiempo de respuesta."},
                {"role": "user", "content": query}
            ]
        }
